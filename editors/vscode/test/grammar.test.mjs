...
test("TextMate grammar assigns semantic scopes to representative Simi syntax", async () => {
  ...
  assertScope(lines, 25, "item", "variable.parameter.simi");
  assertScope(lines, 28, "require", "support.function.builtin.simi");
  assertScope(lines, 29, ".map", "punctuation.accessor.simi");
  assertScope(lines, 29, "map", "variable.other.property.simi", 2);
  assertScope(lines, 29, "<|", "keyword.operator.pipeline.simi");
  assertScope(lines, 32, "raise", "keyword.control.exception.simi");
  assertScope(lines, 33, "catch", "keyword.control.exception.simi");
  assertScope(lines, 34, "=>", "keyword.operator.arm.simi");
  assertScope(lines, 37, "?", "keyword.operator.pipeline.simi");
  assertScope(lines, 40, "state", "variable.other.simi");
  assertScope(lines, 40, "break", "variable.other.property.simi");
  assertScope(lines, 40, "continue", "variable.other.property.simi");
  assertScope(lines, 43, "\\q", "invalid.illegal.escape.simi");
  assertScope(lines, 44, "<>", "keyword.operator.concatenation.simi");
  assertScope(lines, 45, "type", "support.function.builtin.simi");
  assertScope(lines, 45, "==", "keyword.operator.comparison.simi");
  assertScope(lines, 48, "|>", "keyword.operator.pipeline.simi");
  assertScope(lines, 45, "\"integer\"", "string.quoted.double.simi");
  assertScope(lines, 46, "type", "support.function.builtin.simi");
  assertScope(lines, 46, "==", "keyword.operator.comparison.simi");
  assertScope(lines, 46, "\"function\"", "string.quoted.double.simi");
  assertScope(lines, 47, "is", "variable.other.readwrite.simi");
  assertScope(lines, 49, "identity", "entity.name.function.simi");
  assertScope(lines, 49, "'a", "variable.other.generic-type.simi");
  assertScope(lines, 49, "integer", "support.type.primitive.simi");
  assertScope(lines, 49, "value", "variable.parameter.simi");
  assertScope(lines, 49, "!", "keyword.operator.type.simi");
  assertScope(lines, 51, "!", "keyword.operator.type.simi");
  assertScope(lines, 52, "'a", "variable.other.generic-type.simi");
  assertScope(lines, 52, "!", "keyword.operator.type.simi");
  assertScope(lines, 56, "nested", "entity.name.function.simi");
  assertScope(lines, 56, "!", "keyword.operator.type.simi");
  assertScope(lines, 58, "!", "keyword.operator.type.simi");
  assertScope(lines, 59, "!", "keyword.operator.type.simi");
  assertScope(lines, 60, "string", "variable.other.simi");
  assertNotScope(lines, 60, "string", "support.type.primitive.simi");
  assertScope(lines, 60, "to_number", "variable.other.property.simi");
  assertScope(lines, 61, "!=", "keyword.operator.comparison.simi");
  assertNotScope(lines, 61, "!=", "keyword.operator.type.simi");
  assertScope(lines, 63, "requires", "keyword.declaration.simi");
});
