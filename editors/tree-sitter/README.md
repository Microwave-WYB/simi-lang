...
The grammar follows the Rust lexer and parser in `../../src/`, including ASCII identifiers, `--` line comments, string escapes, decimal/exponent numbers, expression-valued blocks, destructuring patterns, match/catch pattern clauses, functional loops, postfix calls/fields/adjacent indexes, assignment, pipelines, and right-associative trailing arguments.
